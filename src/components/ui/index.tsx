  ...
  "inline-flex items-center gap-1 rounded-full px-2.5 py-0.5 text-xs font-medium",
  {
    variants: {
      tom: {
        ...
        cinza: "bg-stone-200/70 text-stone-700",
      },
    },
...
const campoBase =
  "w-full rounded-xl border border-borda bg-white px-4 py-2.5 text-sm text-texto placeholder:text-texto-suave/60 transition-colors focus:border-marca-400 focus:outline-none focus:ring-2 focus:ring-marca-100 disabled:bg-stone-50";
